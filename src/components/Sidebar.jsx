        ...
        >
            ...
            <ul className="mt-5">
                {projects.map((project, index) => {
                    let cssClasses = "p-1 text-start text-stone-50 bg-stone-900 text-stone-50 cursor-pointer text-xs hover:text-stone-400";

                    if (project.id === selectedProjectId) {
                        cssClasses += " bg-stone-400 text-stone-900 hover:text-stone-900";
                    } else {
